...
<head>
    ...
    <title>TOPOS APP LOGIN</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
</head>

<body class="login-body lead text-white text-center" style="background:navy">
<div class="container">
...
<br/>
<svg class="bi bi-shield-lock" width="3em" height="3em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<br/>
            <button class="btn btn-lg btn-login btn-block text-white" type="submit" style="background:magenta">
       Login
            </button>
        </div>
    </form>
...
<p class="text-center">
    <small>Present by<br/><a href="https://mesinkasironline.web.app" class="text-light" target="blank">https://mesinkasironline.web.app</a>
    </small>
    </p>
</div>
